...
use constants;
use data_collection::{ItemId, ItemRef, LocationId, LocationRef, Properties};
...
impl Location {
	...
	pub fn new(id: LocationId, properties: Properties, shortname: String, longname: String, description: String) -> Location {
		Location {
			id: id,
			properties: properties,
			shortname: shortname,
